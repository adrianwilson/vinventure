...
export class VinventureLambdaStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
      ...
      code: lambda.Code.fromInline(`
        exports.handler = async (event) => {
          return {
            ...
            body: JSON.stringify({ message: 'VinVenture API is running!' })
          };
        };
      `),
    ...
    new s3deploy.BucketDeployment(this, 'VinventureHtmlPages', {
      sources: [s3deploy.Source.asset('../../apps/spa-build')],
    ...
    new cdk.CfnOutput(this, 'FirebaseSecretArn', {
      value: firebaseSecret.secretArn,
      description: 'Firebase configuration secret ARN',
    });
